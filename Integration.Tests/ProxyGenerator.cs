...
//     Generated on: 24/03/2019 17:55:24
//
...
namespace Integration.Tests.ProjectWithProxy
{
    ...
    public partial class ExternalServiceProxy : ProxyBase, ExternalService
    {
        ...
        public ExternalServiceProxy(MockStrategyRepository mockStrategyRepository, ExternalService service)
        {
            this.mockStrategyRepository = mockStrategyRepository;
        ...
        public int Get()
        {
            ...
            var mockStrategy = this.mockStrategyRepository.GetMockStrategy(GetId, this.InWantedContext());
            ...
            this.mockStrategyRepository.RemoveStrategy(mockStrategy);
        ...
        {
            var mockStrategy = this.mockStrategyRepository.GetMockStrategy(SetId, this.InWantedContext());
        ...
        public System.Threading.Tasks.Task<System.Int32> GetAsync()
        {
            ...
            var mockStrategy = this.mockStrategyRepository.GetMockStrategy(GetAsyncId, this.InWantedContext());
        ...
        {
            var mockStrategy = this.mockStrategyRepository.GetMockStrategy(SetAsyncId, this.InWantedContext());
