...
//     Generated on: 20/03/2019 19:23:47
//
...
namespace Integration.Tests.ProjectWithProxy
{
    ...
    public partial class ExternalServiceProxy : ExternalServiceProxyBase, ExternalService
    {
        ...
        private static void ApplyMethodMockStrategySet(SubstituteBehaviorStrategy substituteBehaviorStrategy, int i)
        {
            try
            {
                var serviceSubstitute = Container.Resolve<ExternalServiceSetTemplate>(substituteBehaviorStrategy.BehaviorName);
        ...
        private static System.Threading.Tasks.Task<System.Int32> ApplyMethodMockStrategyGetAsync(SubstituteBehaviorStrategy substituteBehaviorStrategy)
        {
            try
            {
                var serviceSubstitute = Container.Resolve<ExternalServiceGetAsyncTemplate>(substituteBehaviorStrategy.BehaviorName);
        ...
        private static void ApplyMethodMockStrategySetAsync(SubstituteBehaviorStrategy substituteBehaviorStrategy, int i)
        {
            try
            {
                var serviceSubstitute = Container.Resolve<ExternalServiceSetAsyncTemplate>(substituteBehaviorStrategy.BehaviorName);
